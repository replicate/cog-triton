...
python3 scripts/triton_fill_template.py triton_templates/preprocessing/config.pbtxt \
     "triton_max_batch_size:${MAX_BATCH_SIZE},tokenizer_dir:${TOKENIZER_DIR},preprocessing_instance_count:${MAX_BATCH_SIZE:-64}" \
...
python3 scripts/triton_fill_template.py triton_templates/postprocessing/config.pbtxt \
    "triton_max_batch_size:${MAX_BATCH_SIZE},tokenizer_dir:${TOKENIZER_DIR},postprocessing_instance_count:${MAX_BATCH_SIZE:-64}" \
